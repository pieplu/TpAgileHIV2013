...
public class Date {
    ...
    /*
     * API JAVA FORMAT: yyyy-MM Parse the String in parameter and verifies this
     * supported by the date of API Java. Note: Leap years are also included.
     *
    ...
    /*
     * API JAVA FORMAT: yyyy-MM-dd Parse the String in parameter and verifies
     * this supported by the date of API Java. Note: Leap years are also
     * included.
     *
     * Throws an exception if it's not supported.
     */
