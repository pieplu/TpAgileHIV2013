...
public class Code {
    ...
    static int indexForCodeE = 1;
    static int indexForCodeH = 1;
    ...
    public static boolean isCodeValid(String code) {
        ...
        if (index == 0 || index == 1) {
            ...
            if (code.length() > MINIMUM_LENGTH_FOR_CODE_E_AND_CODE_H && (code.substring(1, code.length())).equals("" + indexForCodeE)) { //is either E or H
                indexForCodeE++;
                return true;
            } else {
                return false;
            ...
            if (code.length() > MINIMUM_LENGTH_FOR_CODE_E_AND_CODE_H && (code.substring(1, code.length())).equals("" + indexForCodeH)) { //is either E or H
                indexForCodeE++;
                return true;
            } else {
                return false;
