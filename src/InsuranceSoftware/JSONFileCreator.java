...
public class JSONFileCreator {
    ...
    public static ArrayList<JSONArrayObject> createListOfIndividualReclamationJSONObject(String jsonArrayName, JSONFileCreator file){
    ...
    public static ArrayList<JSONArrayObject> createListOfIndividualReclamationXmlNodeToTestNodeName(String jsonArrayName, JSONFileCreator file){
        ArrayList<JSONArrayObject> individualReclamationJSONObjectList = new ArrayList <JSONArrayObject> ();
      
        for (int i = 0; i < file.getJSONArrayByName(jsonArrayName).size(); i++) {
            individualReclamationJSONObjectList.add(new JSONArrayObject(i, file));
            individualReclamationJSONObjectList.get(i).setIndividualReclamationJSONArrayObjectToTestObjectName(i, file);
        }
